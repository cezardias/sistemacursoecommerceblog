...
-- Senha 'Aulad!ret4' com password_hash(PASSWORD_DEFAULT)
...
('Pós-Graduação Gestão', 'O próximo passo da sua carreira começa aqui. Desenvolva competências estratégicas.', 1199.00, 149.99, 10, 'Pós-Graduação'),
