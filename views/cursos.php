<?php
$page_title = "Todos os Cursos - Aula Direta";
render_header();
?>

<section class="bg-navy py-12">
    <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl font-bold text-white mb-4">Nossos Cursos</h1>
        <p class="text-gray-300">Formação de excelência para o seu futuro profissional.</p>
    </div>
</section>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-orange font-medium text-sm">ou
                                <?php echo $c['parcelas']; ?>x de R$
